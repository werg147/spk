...
public class QnaVo {
	...
	private String qna_img_savename;
	...
	public QnaVo(int qna_no, String prod_no, String qna_title, String qna_content, String qna_date, String qna_type,
			int user_no, int buy_no, String qna_img_savename, String user_name) {
		super();
		this.qna_no = qna_no;
	...
	public String toString() {
		return "QnaVo [qna_no=" + qna_no + ", prod_no=" + prod_no + ", qna_title=" + qna_title + ", qna_content="
				...
				+ ", buy_no=" + buy_no + ", qna_img_savename=" + qna_img_savename + ", user_name=" + user_name + "]";
	}
