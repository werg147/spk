    ...
    <div class="container">
        ...
        <div class="page_aticle">
            <div class="page_section section_prdwrite">
                ...
                <h2 class="tit">REVIEW <span class="tit_sub">후기 글쓰기</span></h2>

                <ul class="list_type1 old">
                    <li><span class="ico"></span><p class="txt">상품에 대한 후기를 남기는 공간입니다. 해당 게시판의 성격과 다른 글은 사전동의 없이 담당 게시판으로 이동될 수 있습니다.</p></li>
                ...
                <form name="formQna" method="post" action="${pageContext.request.contextPath}/store/reviewWrite" enctype="multipart/form-data">
                    <input type="hidden" name="prod_no" value="${param.prodNo}">
                    <input type="hidden" name="review_date" value="">
                        ...
                        <colgroup>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th>제목</th>
                                    <td class="subject">
                                        <input type="text" name="review_title" label="제목" value="">
                                    </td>
                                </tr>
                                <tr id="edits">
