					...
					<div class="content_seller_regi">
						...
						<form action="" method="">
							<table class="seller_regi_form">
								<tbody>
									...
									<tr>
										...
										<td><input class="input_con" type="text" name="sellerNo" placeholder="번호를 입력해주세요">
											<div class="seller_alert">'-'와 공백을 제외하고 입력해주세요. (예: 1231212345)</div></td>
									</tr>
									...
									<tr>
										...
										<td><select>
											...
											<div class="seller_alert">'-'와 공백을 제외하고 입력해주세요. (예: 1234567890123)</div></td>
									</tr>
							...
							<div class="seller_regi_btn_site">
								<button onclick="location.href='예약판매자3_마이페이지_사업자계정정보1.html'" class="seller_regi_btn"
									type="button">판매자 등록</button>
							</div>
						</form>
						<!--입력폼-->
