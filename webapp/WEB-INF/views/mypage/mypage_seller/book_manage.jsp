			...
			<div class="middle">
				...
				<div class="content_seller">
					...
					<div class="content_seller_regi">
						...
						<!--입력폼 (추후 form 추가)-->
						<form id="addForm"
							action="${pageContext.request.contextPath}/mypage/book/booksellermodify"
							method="post">
								...
								<tbody>
									...
									<tr>
										...
										<td><input class="input_con" type="text"
											name="book_sell_name" placeholder="이름을 입력해주세요"
											value="${sellervo.book_sell_name}"></td>
									</tr>
									<tr>
										<td class="basic">사업체 이름</td>
										<td><input class="input_con" type="text"
											name="book_com_name" placeholder="회사명을 입력해주세요"
											value="${sellervo.book_com_name}"></td>
									</tr>
									<tr>
										<td class="basic">사업자 번호</td>
										<td><input class="input_con" type="text"
											name="book_business_no" placeholder="번호를 입력해주세요"
											value="${sellervo.book_business_no}">
									...
									<tr>
										...
										<td><select name="book_sell_bank">
												...
												<option value="국민은행"
													${sellervo.book_sell_bank == '국민은행' ? 'selected="selected"' : ''}>국민은행</option>
												<option value="신한은행"
													${sellervo.book_sell_bank == '신한은행' ? 'selected="selected"' : ''}>신한은행</option>
												<option value="우리은행"
													${sellervo.book_sell_bank == '우리은행' ? 'selected="selected"' : ''}>우리은행</option>
												<option value="하나은행"
													${sellervo.book_sell_bank == '하나은행' ? 'selected="selected"' : ''}>하나은행</option>
												<option value="기업은행"
													${sellervo.book_sell_bank == '기업은행' ? 'selected="selected"' : ''}>기업은행</option>
												<option value="농협"
													${sellervo.book_sell_bank == '농협' ? 'selected="selected"' : ''}>농협</option>
												<option value="카카오뱅크"
													${sellervo.book_sell_bank == '카카오뱅크' ? 'selected="selected"' : ''}>카카오뱅크</option>
										</select>
											<div class="account_input">
												<input class="input_con" type="text"
													name="book_sell_account" placeholder="계좌번호를 입력해주세요"
													value="${sellervo.book_sell_account}">
											</div>
											<div class="seller_alert">'-'와 공백을 제외하고 입력해주세요. (예:
