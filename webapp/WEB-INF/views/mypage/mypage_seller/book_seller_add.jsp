					...
					<div class="content_seller_regi">
						...
						<c:choose>
							<c:when test="${authUser.prod_type == 0}">
								<form id="addForm" action="${pageContext.request.contextPath}/mypage/book/bookselleradd" method="post">
							</c:when>
							<c:otherwise>
								<form id="addForm" action="${pageContext.request.contextPath}/mypage/book/booksellermodify" method="post">
						...
						<table class="seller_regi_form">
							<tbody>
								...
								<tr>
									...
									<td><input class="input_con" type="text" name="book_sell_name"
										placeholder="이름을 입력해주세요"></td>
								</tr>
								<tr>
									<td class="basic">사업체 이름</td>
									<td><input class="input_con" type="text" name="book_com_name"
										placeholder="회사명을 입력해주세요"></td>
								</tr>
								<tr>
									<td class="basic">사업자 번호</td>
									<td><input class="input_con" type="text" name="book_business_no"
										placeholder="번호를 입력해주세요">
										<div class="seller_alert">'-'와 공백을 제외하고 숫자만 입력해주세요. (예: 1231212345)</div></td>
								</tr>
								...
								<tr>
									...
									<td><select name="book_sell_bank">
										...
										<div class="account_input">
											<input class="input_con" type="text" name="book_sell_account" placeholder="계좌번호를 입력해주세요">
										</div>
										<div class="seller_alert">'-'와 공백을 제외하고 숫자만 입력해주세요. (예: 1234567890123)</div></td>
								</tr>
