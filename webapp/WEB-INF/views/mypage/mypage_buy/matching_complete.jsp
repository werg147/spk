			...
			<div class="middle">
				...
				<div class="content_product">
					...
					<div class="reservation_info">
						<div class="buy_content_delevery_num">매치번호
							${requestScope.MatchingList[0].booking_no}</div>
						<div>매치일자 ${requestScope.MatchingList[0].b_buy_date}</div>
					</div>
					...
					<div class="buy_delivery_info">
						...
						<div class="buy_deleverymanage_list">
							<div class="buy_delevery_product_content">
								...
								<div class="buy_deleverymanage_list1">
									<table>
										<tr>
											<td>${requestScope.MatchingList[0].nickname}</td>
										</tr>
										<tr>
											<td>${requestScope.MatchingList[0].b_buy_price}</td>
										</tr>
									</table>
									<div class="buy_reservaino_btn">
										<div>${requestScope.MatchingList[0].b_buy_state}</div>
						...
						<div class="delivery_info_personal">
							...
							<div class="delivery_info_content">
								...
								<div class="delivery_info_content_title_re">
									<div>${requestScope.MatchingList[0].nickname}(${requestScope.MatchingList[0].user_name})</div>
									<div>${requestScope.MatchingList[0].height}</div>
									<div>${requestScope.MatchingList[0].weight}</div>
									<div>${requestScope.MatchingList[0].weight_class}</div>
									<div>${requestScope.MatchingList[0].booking_start}~
										${requestScope.MatchingList[0].booking_end}</div>
								</div>
							</div>
						</div>
						...
						<div class="delivery_info_personal">
							...
							<div class="delivery_info_content">
								...
								<div class="delivery_info_content_title_re">
									<div>${requestScope.MatchingList[0].b_buy_paytype}</div>
									<div>${requestScope.MatchingList[0].b_buy_price}원</div>
								</div>
							</div>
						</div>
						<!--delivery_info_persondelevery_btnal-->
					...
					<div class="go_back">
						<button class="go_back_btn">
							<a
								href="${pageContext.request.contextPath }/mypage/matchinglist?user_no=${requestScope.BookingList[0].user_no}">구매목록보기</a>
						</button>
					</div>
				</div>
				<!--//content_product//-->
