					...
					<form action="" id="uploadForm" method="" enctype="">
						<table class="product_insert_content">
							...
							<tr class="basic">
								...
								<td><input type="text" id="prod_name" name="prod_name" value="${prodvo.prod_name}"></td>
							</tr>
							<tr class="basic">
								<td><label for="prod_price">제품가격</label></td>
								<td><input type="text" id="prod_price" name="prod_price" value="${prodvo.prod_price}"></td>
							</tr>
							<tr class="basic">
								<td><label for="prod_brand">브랜드명</label></td>
								<td><input type="text" id="prod_brand" name="prod_brand" value="${prodvo.prod_brand}"></td>
							</tr>
