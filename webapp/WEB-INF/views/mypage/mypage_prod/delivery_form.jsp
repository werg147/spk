		...
		<div class="container">
			...
			<div class="middle">
				...
				<div class="content_product">
					...
					<!--//list//-->
					<form action="${pageContext.request.contextPath}/mypage/prod/delmodify" method="post" >
							...
							<table class="delivery_info_table">
								...
								<tr>
									...
									<td class="content_delevery_num_select_box"><select
										name="buy_delivery">
											<option>택배사선택</option>
											<option ${delfound.buy_delivery == 'CJ대한통운' ? 'selected="selected"' : ''}>CJ대한통운</option>
											<option ${delfound.buy_delivery == '우체국택배' ? 'selected="selected"' : ''}>우체국택배</option>
											<option ${delfound.buy_delivery == '한진택배' ? 'selected="selected"' : ''}>한진택배</option>
											<option ${delfound.buy_delivery == '롯데택배' ? 'selected="selected"' : ''}>롯데택배</option>
											<option ${delfound.buy_delivery == '경동택배' ? 'selected="selected"' : ''}>경동택배</option>
											<option ${delfound.buy_delivery == '일양로지스' ? 'selected="selected"' : ''}>일양로지스</option>
									</select></td>
								</tr>
								<tr>
									<td><label for="deliv_num">운송장번호</label></td>
									<td><input type="text" id="deliv_num" name ="buy_del_no" value="${delfound.buy_del_no}"></td>
								</tr>
							</table>
							<div class="delevery_btn">
								<button class="product_delready_btn" type="button">
									<a href="${pageContext.request.contextPath}/mypage/prod/delstatechange?buyprod_no=${delfound.buyprod_no}">배송준비</a>
								</button>
								<button class="product_delinfosave_btn" type="submit">배송정보저장</button>
								<button class="product_delclose_btn" type="button">
									<a href="${pageContext.request.contextPath}/mypage/prod/delmanage">배송목록으로</a>
								</button>
							</div>
						</div>
